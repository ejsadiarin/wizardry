...
# (How to) Creating Users or Guests to a Linux Machine
...
## Adding user to groups (updated 2026-02-12-1933)

- Add to sudo (or wheel for distributions like CentOS/RHEL)
