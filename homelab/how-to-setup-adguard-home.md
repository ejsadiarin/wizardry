...
_this guide is from [Akash](https://akashrajpurohit.com):_
...
>
> Moreover, I use `keepalived` which creates a virtual IP and can fail between my pihole instances.
>
> I have one instance in a vm and another on a raspberry pi.
>
> Separate hardware is nice so you can update one and still have internet.
>
> Techno Tim has a good video on a setup https://technotim.live/posts/keepalived-ha-loadbalancer/
>
